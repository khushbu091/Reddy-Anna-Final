...
const Privacy_Policy = () => {
  return (
    ...
    <div className="privacy-container">
      ...
      <h2 className="privacy-section">Who we are</h2>
      <p className="privacy-intro">
      <strong>Suggested text:</strong> Our website address is: https://www.redddyanna.com.
      </p>
      
      <h2 className="privacy-section">Comments</h2>
      <p className="privacy-intro">
      ...
      <h2 className="privacy-section">Media</h2>
      <p className="privacy-intro">
      ...
      <h2 className="privacy-section">Cookies</h2>
      ...
      <h2 className="privacy-section">Embedded content from other websites</h2>
      <p className="privacy-text">
      ...
      <h2 className="privacy-section">Who we share your data with</h2>
      <p className="privacy-text">
      <strong>Suggested text:</strong> If you request a password reset, your IP address will be included in the reset email.
      </p>

      <h2 className="privacy-section">How long we retain your data</h2>
      <p className="privacy-text">
      ...
      <h2 className="privacy-section">What rights you have over your data</h2>
      <p className="privacy-text">
      ...
      <h2 className="privacy-section">Where your data is sent</h2>
      <p className="privacy-text">
